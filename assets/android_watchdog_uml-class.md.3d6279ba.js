import{_ as n,o as a,c as l,a as p}from"./app.5f21f102.js";const m=JSON.parse('{"title":"Android watchdog","description":"","frontmatter":{},"headers":[],"relativePath":"android/watchdog/uml-class.md"}'),e={name:"android/watchdog/uml-class.md"};function r(c,s,o,t,i,F){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="android-watchdog" tabindex="-1">Android watchdog <a class="header-anchor" href="#android-watchdog" aria-hidden="true">#</a></h1><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;"></span></span>
