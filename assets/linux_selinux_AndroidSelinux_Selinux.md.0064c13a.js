...
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;">/adb*keys u:object_r:adb_keys_file:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/default\\.prop u:object_r:rootfs:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/fstab\\..* u:object*r:rootfs:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/init\\..* u:object*r:rootfs:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/res(/.*)? u:object*r:rootfs:s0</span></span>
...
<span class="line"><span style="color:#F8F8F2;">#</span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;">/dev(/._)? u:object_r:device:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/dev/akm8973._ u:object*r:sensors_device:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/dev/accelerometer u:object_r:sensors_device:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/dev/adf[0-9]* u:object*r:graphics_device:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">......</span></span>
<span class="line"><span style="color:#F8F8F2;">/dev/tty u:object_r:owntty_device:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/dev/tty[0-9]* u:object*r:tty_device:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/dev/ttyS[0-9]* u:object*r:serial_device:s0</span></span>
...
<span class="line"><span style="color:#F8F8F2;">#</span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;">/data(/._)? u:object_r:system_data_file:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/data/.layout_version u:object_r:install_data_file:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">......</span></span>
<span class="line"><span style="color:#F8F8F2;">/data/mediadrm(/._)? u:object_r:media_data_file:s0</span></span>
...
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;">/data/misc/adb(/._)? u:object_r:adb_keys_file:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/data/misc/audio(/._)? u:object*r:audio_data_file:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/data/misc/bluetooth(/.*)? u:object*r:bluetooth_data_file:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/data/misc/bluedroid(/.*)? u:object*r:bluetooth_data_file:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/data/misc/bluedroid/\\.a2dp_ctrl u:object_r:bluetooth_socket:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">......</span></span>
<span class="line"><span style="color:#F8F8F2;">/data/misc/user(/.*)? u:object*r:misc_user_data_file:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/data/misc/vpn(/.*)? u:object*r:vpn_data_file:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/data/misc/wifi(/.*)? u:object*r:wifi_data_file:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/data/misc/wifi/sockets(/.*)? u:object*r:wpa_socket:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/data/misc/wifi/sockets/wpa_ctrl.* u:object*r:system_wpa_socket:s0</span></span>
...
<span class="line"><span style="color:#F8F8F2;">#</span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;">/cache(/._)? u:object_r:cache_file:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/cache/._\\.data u:object_r:cache_backup_file:s0</span></span>
...
<span class="line"><span style="color:#F8F8F2;">#</span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;">/sys/devices/platform/nfc-power/nfc*power -- u:object_r:sysfs_nfc_power_writable:s0</span></span>
<span class="line"><span style="color:#F8F8F2;">/sys/devices/system/cpu(/.*)? u:object*r:sysfs_devices_system_cpu:s0</span></span>
...
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br></div></div><p>根据SELinux规范，Object Class类型由class关键字申明<br> 2.cat <code>external/sepolicy/access_vectors</code>可以看到如下信息：</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;">#</span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span>
...
<span class="line"><span style="color:#F8F8F2;">}</span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br></div></div><p>SELinux规范中，定义perm set有两种方式:</p><ol><li>common common_name { permission_name ... } common定义的perm set能被另外一种perm set命令class所继承</li><li>class class_name [ inherits common_name ] { permission_name ... } inherits表示继承了某个common定义的权限 注意，class命令定义的权限其实针对得就是某个object class。它不能被其他class继承</li></ol><p>下面用例子说明一下：</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;">common file {</span></span>
...
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;">class dir inherits file {</span></span>
<span class="line"><span style="color:#F8F8F2;">add_name remove_name reparent search rmdir open audit_access execmod</span></span>
<span class="line"><span style="color:#F8F8F2;">}</span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h3 id="_6-3-类型定义" tabindex="-1">6.3 类型定义 <a class="header-anchor" href="#_6-3-类型定义" aria-hidden="true">#</a></h3><p>类型定义通过type 来进行<br><strong>type命令的完整格式为：</strong><code>type type_id [alias alias_id,] [attribute_id]</code> 其中，方括号中的内容为可选。alias指定了type的别名，可以指定多个别名。 下面这个例子定义了一个名为shell的type，它和一个名为domain的属性（attribute）关联 : <code>type shell, domain;</code></p><p>属性由<code>attribute</code>关键字定义，如attributes文件中定义的SEAndroid使用的属性有：</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;">attribute domain</span></span>
<span class="line"><span style="color:#F8F8F2;">attribute file_type</span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>可以在定义type的时候，直接将其和某个attribute关联，也可以单独通过<code>typeattribue</code>将某个type和某个或多个attribute关联起来，如下面这个例子<br> 将前面定义的system类型和mlstrustedsubject属性关联了起来 <code>typeattribute system mlstrustedsubject</code><br><strong>这里需要重点说明一下<code>attribute</code>这个东西</strong> 这里的<code>attribute</code>正确的意思不是属性，而是**<code>群组</code>**的意思。请注意！！！</p><p><code>attribute</code>的作用通过如下的例子来说明：</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;">#定义两个type，分别是A_t和B_t，它们都管理到attribute_test</span></span>
...
<span class="line"><span style="color:#F8F8F2;">allow attribute_test C_t:file {read write}; #上面这个allow语句在编译后的安全策略文件中会被如下两条语句替代：</span></span>
...
<span class="line"><span style="color:#F8F8F2;"></span></span>
<span class="line"><span style="color:#F8F8F2;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><hr><h2 id="_7-如何快速添加一安全性规则" tabindex="-1">7.如何快速添加一安全性规则 <a class="header-anchor" href="#_7-如何快速添加一安全性规则" aria-hidden="true">#</a></h2><ol><li>首先确认你要解的问题的中是那个<code>进程</code>要访问那个<code>文件</code></li><li>由于进程已经存在那个它安全性文本的定义肯定是存在只要找到就行类似这样一条语句<code>u:r:kernel:s0</code></li><li>确认一下文件的安全性文本的定义是否存在，如果不存在则要定义（一般情况下是不存在）,3.1定义类型(参考6.3)3.2在contexts定义安全性文本（参考6.2）</li><li>确认要进行那种操作也就是要确定class和perm_set.</li><li>在相关的.te文件加入规则也就是一条allow相关的语句(参考6.2)。</li></ol><p>例子： 如我们在system_server中加入一个服务，这个服务要操作/dev/i2c-2这个设备结点。 那么安上面的方法：</p><ol><li>确认问题：<code>system_server</code>要访问<code>/dev/i2c-2</code></li><li>确定进程<code>system_server</code>信息<code>u:r:system_server:s0 system 849 232 system_server</code></li><li>由于<code>/dev/i2c-2</code>的安全性文本不存在，所以我们做定义3.1,<code>type i2c2_device, dev_type;</code>3.2,<code>/dev/i2c-2 u:object_r:i2c2_device:s0</code></li><li>确认<code>calss　perm_set</code>为<code>chr_file　{open read write ioctl} </code></li><li>加入规则<code>allow system_server i2c2_device:chr_file { open read write ioctl};</code></li></ol><p>注意：以上信息要写入合适的文件，要以当时的问题来决定。</p><hr>`,82)),o(l,{title:a.$title},null,8,["title"]),s[1]||(s[1]=n('<div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"></div></div>',1))])}const h=e(F,[["render",b]]);export{f as __pageData,h as default};
